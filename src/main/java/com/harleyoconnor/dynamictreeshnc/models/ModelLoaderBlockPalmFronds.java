package com.harleyoconnor.dynamictreeshnc.models;
...
public class ModelLoaderBlockPalmFronds extends ModelLoaderGeneric {
    ...
    public ModelLoaderBlockPalmFronds() {
        this("dynamicpalmfrondshnc");
    }
    public ModelLoaderBlockPalmFronds(String code) {
        super(code, new ResourceLocation(AddonConstants.MOD_ID, "block/smartmodel/dynamicpalmfronds"));
    }
